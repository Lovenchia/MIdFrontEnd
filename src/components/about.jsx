                  ...
                  <div className="col-lg-6">
                    <ul>
                      <li>
                        ...
                        <strong>Name:</strong> <span>Lovenchia Cheren Melinda Warouw</span>
                      </li>
                      <li>
                        <i className="bi bi-chevron-right" />{" "}
                      ...
                      <li>
                        <i className="bi bi-chevron-right" />{" "}
                        <strong>City:</strong> <span>Manado, Malalayang 1 Barat</span>
                      </li>
                    </ul>
                  </div>
                  <div className="col-lg-6">
                    <ul>
                      ...
                      <li>
                        <i className="bi bi-chevron-right" />{" "}
                        <strong>Degree:</strong> <span>S.Kom</span>
                      </li>
                      <li>
                        <i className="bi bi-chevron-right" />{" "}
